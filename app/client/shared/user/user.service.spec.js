...
describe('user service', function() {
    ...
    it('should login user', function() {
        ...
        var userData;
        userServ.login(testProvider).then(function(respData){ userData = respData;});
        $scope.$digest();

        expect(JSON.parse($window.localStorage.getItem(userServ.USER_OATH_KEY)).access_token)
    ...
    it('should logout user', function() {
        $window.localStorage.setItem(userServ.USER_OATH_KEY, angular.toJson({test: "data", for: "oauth"}));
        $window.localStorage.setItem(userServ.USER_DATA_KEY, angular.toJson({test: "data", for: "user"}));
        userServ.logout();
    ...
    it('should check if user is logged in', function() {
        ...
        $window.localStorage.setItem(userServ.USER_OATH_KEY, angular.toJson(testOauthData));
