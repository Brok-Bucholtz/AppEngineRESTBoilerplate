...
angular.module('user.services', [
    ...
    .factory('UserService', [ '$q', '$window', 'UserResource', 'OauthService', function($q, $window, userResource, oauthService) {
            ...
            return $q(function(resolve, reject) {
                oauthService.popup(provider)
                    .then(function (response) {
                        ...
                        $window.localStorage.setItem(USER_OATH_KEY, angular.toJson(oauth));
                        resolve(response);
                    }, reject);
            });
        };
            ...
            return $q(function(resolve, reject) {
                userResource
                    ...
                    .$promise.then(function (userData) {
                        ...
                        $window.localStorage.setItem(USER_DATA_KEY, angular.toJson(user));
                        resolve(user);
                    }, reject);
            });
        };
